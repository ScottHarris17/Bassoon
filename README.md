# Bassoon
Develop, organize, and deploy vision science experiments. Bassoon is a python based GUI and API to easily manage and deploy visual stimuli. While the stimuli included with this project rely on <a href = 'www.psychopy.org'>Psychopy</a>, any stimulus framework can in theory be used with local copies of Bassoon.
