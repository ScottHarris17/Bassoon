# -*- coding: utf-8 -*-
"""
Created on Tue Mar  1 19:57:01 2022
...
class StaticGrating(protocol):
    ...
    def run(self, win, informationWin):
        ...
        if self.userInitiated:
            self.showInformationText(win, 'Stimulus Information: Static Grating\nPress any key to begin')
        ...
        for ori in self._orientationLog:
            ...
            if self._informationWin[0]:
                self.showInformationText(win, 'Running Static Grating Direction. Current orientation = ' + \
